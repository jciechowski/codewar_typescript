/// <reference path="../src/rainfall.ts" />
...
var solution = Rainfall;
describe("Fixed Tests", function () {
    it("Basic tests: mean for data", function () {
        expect(solution.mean("London", data)).toEqual(51.199999999999996);
        expect(solution.mean("Beijing", data)).toEqual(52.416666666666664);
    });
});
describe("Fixed Tests", function () {
    it("Basic tests: variance for data", function () {
        expect(solution.variance("London", data)).toEqual(57.428333333333335);
        expect(solution.variance("Beijing", data)).toEqual(4808.37138888889);
    });
});
describe('Missing city in data', function () {
    it('should return -1', function () {
        // expect(solution.mean('Gdansk', data)).toEqual(-1);
        // expect(solution.variance('Gdansk', data)).toEqual(-1);
        expect(solution.mean('Lon', data)).toEqual(-1);
        // expect(solution.variance('Lon', data)).toEqual(-1);
    });
});
